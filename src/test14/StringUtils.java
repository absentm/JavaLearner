...
public class StringUtils {
    ...
    public static void test() {
        ...
        System.out.println("chatAt(): " + chatAt("nihao", 2));

        Date now = new Date();
        System.out.println("formatDate(Date, ''): " + formatDate(now, "yyyy/MM/dd hh/mm/ss"));
        System.out.println("formatDate(Date): " + formatDate(now));
        System.out.println("formatDate(long date): " +  formatDate(141536480014L));
        System.out.println("getDate(): " + getDate());
        System.out.println("createFileName(): " + createFileName());
        System.out.println("getDateTime(): " + getDateTime());
        System.out.println("formatDateTime(date): " + formatDateTime(now));
        System.out.println("formatDateTime(long): " + formatDateTime(141536480014L));
        System.out.println("generateTime(): " + generateTime(100000L));

        ArrayList<String> arrayList = new ArrayList<>();
        arrayList.add("hello ");
        arrayList.add("nihao");
        arrayList.add("zhongguo");
        System.out.println("join(): " + join(arrayList, "@"));

        System.out.println("generateFileSize(): " + generateFileSize(148637774));
        System.out.println("getTimeDiff(long): " + getTimeDiff(148637774));
        System.out.println("getChineseCharCount(): " + getChineseCharCount("sha你好madhsa似的"));
        System.out.println("getEnglishCount(): " + getEnglishCount("sha你好madhsa似的"));
    }
}
